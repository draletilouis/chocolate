...
Stack: Next.js (App Router), React, TypeScript, Tailwind CSS v4, Lucide icons. Data is sample data kept in the browser (`localStorage`); reset it from **Setup → Alert thresholds → Reset sample data**.
